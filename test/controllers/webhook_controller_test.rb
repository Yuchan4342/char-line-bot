...
class WebhookControllerTest < ActionDispatch::IntegrationTest
  ...
  test "メニュー'メニュー追加'に対する動作" do
    ...
    post callback_path, params: text_message_event('メニュー追加')
    assert_response :success
    ...
    post callback_path, params: text_message_event('メニュー追加', 'hoge2')
    assert_response :success
  ...
  test "メニュー'メニュー削除'に対する動作" do
    ...
    post callback_path, params: text_message_event('メニュー削除')
    assert_response :success
    ...
    # linked = false (リッチメニューが追加されていない)の場合
    post callback_path, params: text_message_event('メニュー削除', 'hoge2')
    assert_response :success
